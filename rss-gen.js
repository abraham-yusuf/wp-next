...
const blogPostsRssXml = blogPosts => {
  ...
  blogPosts.forEach(({ node }) => {
    ...
    const postHref = `https://www.abrahamyusuf.my.id/blog/${post.slug}`;
...
const getRssXml = blogPosts => {
  ...
  >
    <channel>
        <title><![CDATA[ Catatan Abraham Yusuf ]]></title>
        <link>https://www.abrahamyusuf.my.id</link>
        <description>
          <![CDATA[ Sebuah Blog Tempat Berbagi Cerita Dan Pengalaman Teknologi Era 4.0 ]]>
        </description>
